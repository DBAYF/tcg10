...
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.ENUM('tournament', 'meetup', 'draft', 'sealed', 'casual')),
    __metadata("design:type", String)
], Event.prototype, "eventType", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.ENUM('community', 'official')),
    __metadata("design:type", String)
