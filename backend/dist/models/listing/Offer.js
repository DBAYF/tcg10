...
let Offer = class Offer extends sequelize_typescript_1.Model {
};
exports.Offer = Offer;
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], Offer.prototype, "buyerId", void 0);
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.ENUM('pending', 'accepted', 'declined', 'countered')),
    __metadata("design:type", String)
